...
import com.google.android.exoplayer.controller.GoatMediaController;
import com.google.android.exoplayer.controller.GoatMediaController.IGoatCallBack;
 ...
 */
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener, DemoPlayer.Listener,
		DemoPlayer.CaptionListener, DemoPlayer.Id3MetadataListener, AudioCapabilitiesReceiver.Listener, IGoatCallBack, OnSystemUiVisibilityChangeListener {
...
//		setContentView(R.layout.player_activity);
	...
	private void preparePlayer(boolean playWhenReady) {
		...
		if (player == null) {
			...
			goatMediaController.setMediaPlayer(player.getPlayerControl());
			goatMediaController.setEnabled(true);
			goatMediaController.registerCallBack(this);
	...
	private void toggleControlsVisibility() {
		...
		if (goatMediaController.isShowing()) {
			goatMediaController.hide();
	...
	/**
	 * Makes a best guess to infer the type from a media {@link Uri} and an
	 * optional overriding file extension.
	 *
	 * @param uri
	 *            The {@link Uri} of the media.
	 * @param fileExtension
	 *            An overriding file extension.
	...
	public void onBack() {
		...
		builder.setTitle("ABC").setItems(R.array.abc, new DialogInterface.OnClickListener() {
	...
	public void onFullScreen() {
		...
		if (getRequestedOrientation() != ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
			...
			params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 0, 2);
	...
	public void onBackPressed() {
		if (getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
			onFullScreen();
			goatMediaController.updateScaleButton();
		} else {
			super.onBackPressed();
		}
	}
	...
	public void onSystemUiVisibilityChange(int visibility) {
		Log.i(TAG, "onSystemUiVisibilityChange > " + ((visibility & View.SYSTEM_UI_FLAG_FULLSCREEN) == 0));
		Log.i(TAG, "onSystemUiVisibilityChange > LANDSCAPE: " + (getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE));
		if ((getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE)) {
	        mHandler.sendEmptyMessageDelayed(FULLSREEN_MSG, TIME_BEFORE_HIDE_UI);
	    }
	}
}
